...
var handle = websocket.connect(
    ...
    function(h) { console.log("连接成功，句柄: " + h); },
    function(h) { console.log("连接关闭，句柄: " + h); },
    function(h, err) { console.log("错误: " + err); },
    function(h, msg) { console.log("收到消息: " + msg); }
);
...
**使用示例：**
```javascript
var ws = websocket.connectObject(
    "ws://echo.websocket.org",
...
var ws1 = websocket.connectObject(
    "ws://echo.websocket.org",
    function(conn) { 
        console.log("连接1成功"); 
...
var ws2 = websocket.connectObject(
    "ws://echo.websocket.org",
    function(conn) { 
        console.log("连接2成功"); 
